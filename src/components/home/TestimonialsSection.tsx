      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-3 rounded-full border border-primary/10 bg-surface px-5 py-2.5 shadow-sm transition-colors hover:border-accent/30 hover:shadow-md"
          >
