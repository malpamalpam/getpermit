...
const TYPE_BADGES: Record<string, { label: string; cls: string }> = {
  ...
  ZEZWOLENIE_A: { label: "Zezw. A", cls: "bg-blue-100 text-blue-800" },
  ...
  ZGLOSZENIE_UA: { label: "Powiad. UA", cls: "bg-pink-100 text-pink-800" },
  POWIADOMIENIE_UA: { label: "Powiad. UA", cls: "bg-pink-100 text-pink-800" },
  KARTA_POBYTU: { label: "TRC", cls: "bg-yellow-100 text-yellow-800" },
  TRC_FDK: { label: "TRC FDK", cls: "bg-yellow-100 text-yellow-800" },
  TRC_HUMANITARNE: { label: "TRC human.", cls: "bg-yellow-100 text-yellow-800" },
  TRC_POBYT_Z_CUDZ: { label: "TRC pobyt", cls: "bg-yellow-100 text-yellow-800" },
  TRC_MALZONEK_PL: { label: "TRC małż.", cls: "bg-yellow-100 text-yellow-800" },
  TRC_STUDIA: { label: "TRC studia", cls: "bg-yellow-100 text-yellow-800" },
  TRC_ABSOLWENT: { label: "TRC absol.", cls: "bg-yellow-100 text-yellow-800" },
  TRC_DZIALALNOSC: { label: "TRC dział.", cls: "bg-yellow-100 text-yellow-800" },
  ...
  DOSTEP_POBYT_STALY: { label: "OD stały", cls: "bg-emerald-100 text-emerald-800" },
  OD_POBYT_STALY: { label: "OD stały", cls: "bg-emerald-100 text-emerald-800" },
  DOSTEP_REZYDENT_UE: { label: "OD rezyd.", cls: "bg-emerald-100 text-emerald-800" },
  OD_REZYDENT_UE: { label: "OD rezyd.", cls: "bg-emerald-100 text-emerald-800" },
  DOSTEP_KARTA_POLAKA: { label: "OD KP", cls: "bg-emerald-100 text-emerald-800" },
  OD_KARTA_POLAKA: { label: "OD KP", cls: "bg-emerald-100 text-emerald-800" },
  DOSTEP_OCHRONA_MIEDZ: { label: "OD ochrona", cls: "bg-emerald-100 text-emerald-800" },
  OD_OCHRONA_UZUP: { label: "OD ochrona", cls: "bg-emerald-100 text-emerald-800" },
  OD_UCHODZCA: { label: "OD uchodź.", cls: "bg-emerald-100 text-emerald-800" },
  OD_WIZA_HUMAN: { label: "OD wiza h.", cls: "bg-emerald-100 text-emerald-800" },
  DOSTEP_DYPLOM_PL: { label: "OD absol.", cls: "bg-emerald-100 text-emerald-800" },
  OD_ABSOLWENT: { label: "OD absol.", cls: "bg-emerald-100 text-emerald-800" },
