...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: t("title"),
      description: t("description"),
      url: locale === "pl" ? siteConfig.url : `${siteConfig.url}/${locale}`,
    ...
    alternates: {
      canonical: locale === "pl" ? siteConfig.url : `${siteConfig.url}/${locale}`,
      languages: {
        ...Object.fromEntries(
          routing.locales.map((l) => [l, l === "pl" ? siteConfig.url : `${siteConfig.url}/${l}`])
        ),
