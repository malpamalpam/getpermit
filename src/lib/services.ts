    ...
    services: [
      {
        ...
        requiredDocuments: {
          pl: [
            "Wniosek złożony przez system MOS (Moduł Obsługi Spraw)",
            "Załącznik nr 1 do wniosku (od pracodawcy)",
            "Fotografia cyfrowa (do wniosku przez system MOS)",
          ...
          en: [
            "Application submitted via the MOS system (Case Handling Module)",
            "Appendix No. 1 to the application (from the employer)",
            "Digital photograph (for application via the MOS system)",
          ...
          ru: [
            "Заявление, поданное через систему MOS (Модуль обработки дел)",
            "Приложение № 1 к заявлению (от работодателя)",
            "Цифровая фотография (для заявления через систему MOS)",
          ...
          uk: [
            "Заява, подана через систему MOS (Модуль обробки справ)",
            "Додаток № 1 до заяви (від роботодавця)",
            "Цифрова фотографія (для заяви через систему MOS)",
      ...
      },
      {
        ...
        requiredDocuments: {
          pl: [
            "Wniosek złożony przez system MOS — zezwolenie na pobyt w celu wykonywania pracy wymagającej wysokich kwalifikacji",
            "Dyplom ukończenia studiów wyższych (uznany w Polsce)",
            "Umowa o pracę lub oferta pracy na co najmniej 6 miesięcy",
          ...
          en: [
            "Application submitted via the MOS system — residence permit for highly qualified employment",
            "Higher education diploma (recognized in Poland)",
            "Employment contract or job offer for at least six months",
          ...
          ru: [
            "Заявление через систему MOS — разрешение на пребывание для работы, требующей высокой квалификации",
            "Диплом о высшем образовании (признанный в Польше)",
            "Трудовой договор или предложение работы минимум на шесть месяцев",
          ...
          uk: [
            "Заява через систему MOS — дозвіл на перебування для роботи, що вимагає високої кваліфікації",
            "Диплом про вищу освіту (визнаний у Польщі)",
            "Трудовий договір або пропозиція роботи мінімум на шість місяців",
      ...
      },
      {
        ...
        requiredDocuments: {
          pl: [
            "Wniosek o wymianę karty pobytu (składany przez system MOS)",
            "Aktualna fotografia",
            "Kopia ważnego dokumentu podróży",
          ...
          en: [
            "Application for residence card replacement (submitted via the MOS system)",
            "Recent photograph",
            "Copy of a valid travel document",
          ...
          ru: [
            "Заявление на замену карты побыту (подаётся через систему MOS)",
          ...
          uk: [
            "Заява на заміну карти побуту (подається через систему MOS)",
    ...
    services: [
      {
        ...
        requiredDocuments: {
          pl: [
            "Wniosek złożony przez system MOS — zezwolenie na pobyt rezydenta długoterminowego UE",
            "Fotografia cyfrowa (do wniosku przez system MOS)",
            "Kopia ważnego dokumentu podróży",
          ...
          en: [
            "Application submitted via the MOS system — EU long-term resident permit",
            "Digital photograph (for application via the MOS system)",
            "Copy of a valid travel document",
          ...
          ru: [
            "Заявление через систему MOS — разрешение на пребывание долгосрочного резидента ЕС",
            "Цифровая фотография (для заявления через систему MOS)",
            "Копия действующего проездного документа",
          ...
          uk: [
            "Заява через систему MOS — дозвіл на перебування довгострокового резидента ЄС",
            "Цифрова фотографія (для заяви через систему MOS)",
            "Копія дійсного проїзного документа",
      ...
      },
      {
        ...
        requiredDocuments: {
          pl: [
            "Wniosek złożony przez system MOS — zezwolenie na pobyt stały",
            "Fotografia cyfrowa (do wniosku przez system MOS)",
            "Kopia ważnego dokumentu podróży",
          ...
          en: [
            "Application submitted via the MOS system — permanent residence permit",
            "Digital photograph (for application via the MOS system)",
            "Copy of a valid travel document",
          ...
          ru: [
            "Заявление через систему MOS — разрешение на постоянное пребывание",
            "Цифровая фотография (для заявления через систему MOS)",
            "Копия действующего проездного документа",
          ...
          uk: [
            "Заява через систему MOS — дозвіл на постійне перебування",
            "Цифрова фотографія (для заяви через систему MOS)",
            "Копія дійсного проїзного документа",
  ...
  /* ====================== 6. DLA PRACODAWC\u00d3W (Legalizacja pracy) ======== */
  {
    ...
    services: [
      ...
      },
      {
        ...
        forWhom: loc(
          "Pracodawcy zatrudniający obywateli Ukrainy, Białorusi, Mołdawii lub Armenii oraz sami cudzoziemcy z tych krajów.",
          "Employers hiring citizens of Ukraine, Belarus, Moldova, or Armenia, and the foreigners themselves from these countries.",
          "Работодатели, нанимающие граждан Украины, Беларуси, Молдовы или Армении, а также сами иностранцы из этих стран.",
          "Роботодавці, що наймають громадян України, Білорусі, Молдови або Вірменії, та самі іноземці з цих країн."
        ),
        requiredDocuments: {
          pl: [
