    ...
    services: [
        ...
        sections: [
          {
            ...
            body: loc("<p>Ubezpieczenie zdrowotne (ZUS lub prywatne pokrywające leczenie w Polsce). Wynagrodzenie cudzoziemca nie niższe niż porównywalnych pracowników i <strong>nie niższe niż minimalne wynagrodzenie niezależnie od wymiaru czasu pracy</strong> (w 2026 roku to 4 806 zł brutto). W zawodach regulowanych wymagane są dokumenty potwierdzające uprawnienia. Procedura nie obejmuje m.in. pracowników delegowanych, pracowników sezonowych i osób na wizach turystycznych. Dla wysoko wykwalifikowanych specjalistów alternatywą może być <a href=\"/uslugi/eu-blue-card\">EU Blue Card</a>.</p>", "<p>Health insurance (ZUS or private insurance covering treatment in Poland). The foreigner's salary must be no lower than that of comparable employees and <strong>no lower than the minimum wage regardless of working hours</strong> (in 2026 this is 4,806 PLN gross). In regulated professions, documents confirming qualifications are required. The procedure does not cover, among others, posted workers, seasonal workers, and persons on tourist visas. For highly qualified specialists, an alternative may be the <a href=\"/uslugi/eu-blue-card\">EU Blue Card</a>.</p>", "<p>Медицинская страховка (ZUS или частная, покрывающая лечение в Польше). Заработная плата иностранца не ниже, чем у сопоставимых работников, и <strong>не ниже минимальной заработной платы независимо от продолжительности рабочего времени</strong> (в 2026 году — 4 806 злотых брутто). В регулируемых профессиях требуются документы, подтверждающие квалификацию. Процедура не распространяется, в частности, на командированных работников, сезонных работников и лиц с туристическими визами. Для высококвалифицированных специалистов альтернативой может быть <a href=\"/uslugi/eu-blue-card\">Голубая карта ЕС (EU Blue Card)</a>.</p>", "<p>Медичне страхування (ubezpieczenie zdrowotne) (ZUS або приватне, що покриває лікування в Польщі). Заробітна плата іноземця не нижча, ніж у порівнянних працівників, і <strong>не нижча за мінімальну заробітну плату незалежно від обсягу робочого часу</strong> (у 2026 році — 4 806 злотих брутто). У регульованих професіях необхідні документи, що підтверджують кваліфікацію. Процедура не поширюється, зокрема, на відряджених працівників, сезонних працівників та осіб із туристичними візами. Для висококваліфікованих спеціалістів альтернативою може бути <a href=\"/uslugi/eu-blue-card\">Блакитна карта ЄС (EU Blue Card)</a>.</p>"),
          },
          {
        ...
        faq: [
          {
            ...
            answer: loc("Jeśli przed złożeniem wniosku miałeś prawo do pracy (np. <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">oświadczenie</a>, poprzednie <a href=\"/uslugi/zezwolenie-na-prace\">zezwolenie na pracę</a>), zwykle tak — jednak zawsze wymagana jest dokładna analiza sprawy.", "If you had the right to work before submitting the application (e.g., an <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">employer's declaration on entrusting work</a>, a previous <a href=\"/uslugi/zezwolenie-na-prace\">work permit</a>), usually yes — however, a thorough analysis of each case is always required.", "Если до подачи заявления у вас было право на работу (например, <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">заявление о поручении работы (oświadczenie)</a>, предыдущее <a href=\"/uslugi/zezwolenie-na-prace\">разрешение на работу</a>), обычно да — однако всегда требуется тщательный анализ дела.", "Якщо до подання заяви ви мали право на роботу (наприклад, <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">заява про доручення роботи (oświadczenie)</a>, попередній <a href=\"/uslugi/zezwolenie-na-prace\">дозвіл на роботу</a>), зазвичай так — однак завжди необхідний ретельний аналіз справи."),
          },
          {
      ...
      },
      {
        ...
        sections: [
          ...
          {
            heading: loc("Na co uważać", "What to watch out for", "На что обратить внимание", "На що звернути увагу"),
            body: loc("<p>Cel pobytu trzeba realizować — porzucenie studiów czy fikcyjna działalność może oznaczać cofnięcie zezwolenia. Zmiana celu pobytu wymaga złożenia nowego wniosku. Wniosek trzeba złożyć najpóźniej ostatniego dnia legalnego pobytu. Jeśli urząd przekracza terminy, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.</p>", "<p>You must fulfill the purpose of your stay — abandoning studies or fictitious business activity may result in the revocation of the permit. Changing the purpose of stay requires submitting a new application. The application must be submitted no later than the last day of legal stay. If the office exceeds deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.</p>", "<p>Цель пребывания необходимо осуществлять — прекращение учёбы или фиктивная деятельность могут повлечь отмену разрешения. Изменение цели пребывания требует подачи нового заявления. Заявление необходимо подать не позднее последнего дня легального пребывания. Если ведомство нарушает сроки, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.</p>", "<p>Мету перебування потрібно реалізовувати — припинення навчання чи фіктивна діяльність може означати скасування дозволу. Зміна мети перебування потребує подання нової заяви. Заяву потрібно подати не пізніше останнього дня легального перебування. Якщо відомство перевищує строки, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>.</p>"),
          },
        ],
        faq: [
          {
            ...
            answer: loc("Tylko jeśli podstawa decyzji daje dostęp do rynku pracy albo masz dokument legalizujący pracę. Jeśli chcesz pracować, rozważ <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">zezwolenie na pobyt czasowy i pracę</a>.", "Only if the basis of the decision grants access to the labor market or you hold a document authorizing work. If you want to work, consider a <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">temporary residence and work permit</a>.", "Только если основание решения даёт доступ к рынку труда или у вас есть документ, легализующий работу. Если вы хотите работать, рассмотрите <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">разрешение на временное проживание и работу</a>.", "Тільки якщо підстава рішення дає доступ до ринку праці або ви маєте документ, що легалізує роботу. Якщо ви хочете працювати, розгляньте <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">дозвіл на тимчасове проживання та роботу</a>."),
          },
          {
          ...
          },
          {
            ...
            answer: loc("Weryfikacja możliwości złożenia wniosku o kolejne zezwolenie. Jeśli zmieniły się dane osobowe, konieczna może być <a href=\"/uslugi/wymiana-karty-pobytu\">wymiana karty pobytu</a>.", "Verify the possibility of applying for a subsequent permit. If your personal data has changed, a <a href=\"/uslugi/wymiana-karty-pobytu\">residence card replacement</a> may be necessary.", "Проверка возможности подачи заявления на очередное разрешение. Если изменились личные данные, может потребоваться <a href=\"/uslugi/wymiana-karty-pobytu\">замена карты побыту</a>.", "Перевірка можливості подання заяви на наступний дозвіл. Якщо змінилися особисті дані, може знадобитися <a href=\"/uslugi/wymiana-karty-pobytu\">заміна карти побиту</a>."),
          },
          {
      ...
      },
      {
        ...
        faq: [
          ...
          },
          {
            ...
            answer: loc("Jeśli jesteś w procedurze pobytowej (<a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">zezwolenie na pobyt czasowy i pracę</a> lub <a href=\"/uslugi/eu-blue-card\">Blue Card</a>), musisz zarabiać co najmniej 4 806 zł brutto miesięcznie (minimalne wynagrodzenie na 2026 r.). Jeśli urząd przekracza terminy, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.", "If you are in a residence procedure (<a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">temporary residence and work permit</a> or <a href=\"/uslugi/eu-blue-card\">EU Blue Card</a>), you must earn at least 4,806 PLN gross per month (minimum wage for 2026). If the office exceeds deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.", "Если вы находитесь в процедуре получения разрешения на проживание (<a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">разрешение на временное проживание и работу (единое разрешение)</a> или <a href=\"/uslugi/eu-blue-card\">Голубая карта ЕС</a>), вы должны зарабатывать не менее 4 806 злотых брутто в месяц (минимальная заработная плата на 2026 г.). Если ведомство нарушает сроки, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.", "Якщо ви перебуваєте у процедурі отримання дозволу на проживання (<a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">дозвіл на тимчасове проживання та роботу (єдиний дозвіл)</a> або <a href=\"/uslugi/eu-blue-card\">Блакитна карта ЄС</a>), ви повинні заробляти щонайменше 4 806 злотих брутто на місяць (мінімальна заробітна плата на 2026 р.). Якщо відомство перевищує строки, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>."),
          },
          {
      ...
      },
      {
        ...
        sections: [
          ...
          {
            heading: loc("Obowiązki po uzyskaniu decyzji", "Obligations after the decision", "Обязанности после получения решения", "Обов'язки після отримання рішення"),
            body: loc("<p>Zawiadomienie wojewody w 15 dni roboczych o utracie pracy, zmianie pracodawcy, zaprzestaniu spełniania warunków. Jeśli urząd przekracza terminy, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.</p>", "<p>Notifying the voivode within 15 business days of job loss, change of employer, or ceasing to meet the conditions. If the office exceeds deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.</p>", "<p>Уведомление воеводы (wojewoda) в 15 рабочих дней об утрате работы, смене работодателя, прекращении соответствия условиям. Если ведомство нарушает сроки, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.</p>", "<p>Повідомлення воєводи (wojewoda) протягом 15 робочих днів про втрату роботи, зміну роботодавця, припинення відповідності умовам. Якщо відомство перевищує строки, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>.</p>"),
          },
        ],
        faq: [
          {
      ...
      },
      {
        ...
        faq: [
          ...
          },
          {
            ...
            answer: loc("Zależy od danego urzędu (zazwyczaj od miesiąca do kilku miesięcy). Jeśli urząd przekracza terminy, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.", "It depends on the specific office (usually from one month to several months). If the office exceeds deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.", "Зависит от конкретного ведомства (обычно от месяца до нескольких месяцев). Если ведомство нарушает сроки, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.", "Залежить від конкретного відомства (зазвичай від місяця до кількох місяців). Якщо відомство перевищує строки, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>."),
          },
        ],
      },
    ],
    ...
    services: [
      {
        ...
        sections: [
          ...
          {
            heading: loc("Na co uważać", "What to watch out for", "На что обратить внимание", "На що звернути увагу"),
            body: loc("<p>Przerwy w pobycie (pojedyncza przerwa nie może być dłuższa niż 6 miesięcy, a łącznie przerwy nie mogą przekraczać 10 miesięcy w okresie 5 lat — istnieją wyjątki w liczeniu przerw, np. wyjazdy służbowe); dochód liczony wstecz — braki w PIT-ach lub brak umów mogą być przyczyną odmowy; brak możliwości ubiegania się o zezwolenie bez potwierdzenia znajomości języka. Jeśli urząd przekracza terminy, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.</p>", "<p>Breaks in residence (a single break cannot exceed 6 months, and total breaks cannot exceed 10 months over the 5-year period — there are exceptions in counting breaks, e.g., business trips); income is calculated retrospectively — gaps in PIT tax returns or missing contracts may result in refusal; it is not possible to apply for the permit without confirmed language proficiency. If the office exceeds deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.</p>", "<p>Перерывы в проживании (отдельный перерыв не может превышать 6 месяцев, а суммарно перерывы не могут превышать 10 месяцев за 5 лет — существуют исключения в подсчёте перерывов, например, командировки); доход рассчитывается ретроспективно — пробелы в декларациях PIT или отсутствие договоров могут быть причиной отказа; невозможно подать заявление без подтверждения знания языка. Если ведомство нарушает сроки, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.</p>", "<p>Перерви у проживанні (окрема перерва не може перевищувати 6 місяців, а загалом перерви не можуть перевищувати 10 місяців за 5 років — існують винятки у підрахунку перерв, наприклад, службові відрядження); дохід розраховується ретроспективно — прогалини у деклараціях PIT або відсутність договорів можуть бути причиною відмови; неможливо подати заяву без підтвердження знання мови. Якщо відомство перевищує строки, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>.</p>"),
          },
        ],
        faq: [
          {
      ...
      },
      {
        ...
        sections: [
          ...
          {
            heading: loc("Na co uważać", "What to watch out for", "На что обратить внимание", "На що звернути увагу"),
            body: loc("<p>Przy podstawie małżeńskiej urząd bada realność związku; pobyt stały można utracić przy dłuższej nieobecności w Polsce. Jeśli urząd przekracza terminy, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.</p>", "<p>For marriage-based applications, the office examines the authenticity of the relationship; permanent residence can be lost in the event of a prolonged absence from Poland. If the office exceeds deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.</p>", "<p>При основании по браку ведомство проверяет подлинность отношений; разрешение на постоянное проживание (zezwolenie na pobyt stały) можно утратить при длительном отсутствии в Польше. Если ведомство нарушает сроки, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.</p>", "<p>При шлюбній підставі відомство перевіряє реальність відносин; дозвіл на постійне проживання (zezwolenie na pobyt stały) можна втратити при тривалій відсутності в Польщі. Якщо відомство перевищує строки, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>.</p>"),
          },
        ],
        faq: [
          {
        ...
        faq: [
          {
            ...
            answer: loc("Tak — często wymusza podjęcie działań oraz jest wymagane przed złożeniem skargi do sądu. Ponaglenie składamy najczęściej w sprawach o <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">zezwolenie na pobyt i pracę</a>, <a href=\"/uslugi/karta-pobytu-czasowego\">pobyt czasowy</a>, <a href=\"/uslugi/karta-stalego-pobytu\">pobyt stały</a> oraz <a href=\"/uslugi/rezydent-dlugoterminowy-ue\">pobyt rezydenta długoterminowego UE</a>.", "Yes — it often forces the office to take action and is required before filing a complaint with the court. We most frequently file reminders in cases concerning <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">residence and work permits</a>, <a href=\"/uslugi/karta-pobytu-czasowego\">temporary residence</a>, <a href=\"/uslugi/karta-stalego-pobytu\">permanent residence</a>, and <a href=\"/uslugi/rezydent-dlugoterminowy-ue\">EU long-term resident status</a>.", "Да — часто заставляет ведомство предпринять действия и является обязательным условием перед подачей жалобы в суд. Понаглене чаще всего подаём по делам о <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">разрешении на проживание и работу</a>, <a href=\"/uslugi/karta-pobytu-czasowego\">временном проживании</a>, <a href=\"/uslugi/karta-stalego-pobytu\">постоянном проживании</a> и <a href=\"/uslugi/rezydent-dlugoterminowy-ue\">статусе долгосрочного резидента ЕС</a>.", "Так — часто змушує відомство вжити заходів та є необхідною умовою перед подачею скарги до суду. Понаглення найчастіше подаємо у справах про <a href=\"/uslugi/zezwolenie-na-pobyt-czasowy-i-prace\">дозвіл на проживання та роботу</a>, <a href=\"/uslugi/karta-pobytu-czasowego\">тимчасове проживання</a>, <a href=\"/uslugi/karta-stalego-pobytu\">постійне проживання</a> та <a href=\"/uslugi/rezydent-dlugoterminowy-ue\">статус довгострокового резидента ЄС</a>."),
          },
          {
    ...
    services: [
      {
        ...
        sections: [
          {
            heading: loc("Co obejmuje usługa GetPermit", "What the GetPermit service includes", "Что включает услуга GetPermit", "Що включає послуга GetPermit"),
            body: loc("<ul><li>weryfikacja, które dokumenty w Twojej sprawie faktycznie wymagają tłumaczenia (nie płacisz za zbędne);</li><li>tłumaczenie przysięgłe (najczęstsze języki naszych klientów to ukraiński, rosyjski, angielski i białoruski — obsługujemy również inne).</li></ul><p>Tłumaczenia przysięgłe są wymagane m.in. w procedurach <a href=\"/uslugi/eu-blue-card\">EU Blue Card</a> (dyplomy) oraz <a href=\"/uslugi/karta-stalego-pobytu\">pobytu stałego</a> (akty stanu cywilnego, dokumenty pochodzeniowe).</p>", "<ul><li>verification of which documents in your case actually require translation (you do not pay for unnecessary ones);</li><li>sworn translation (the most common languages of our clients are Ukrainian, Russian, English, and Belarusian — we also handle other languages).</li></ul><p>Sworn translations are required in, among others, <a href=\"/uslugi/eu-blue-card\">EU Blue Card</a> procedures (diplomas) and <a href=\"/uslugi/karta-stalego-pobytu\">permanent residence</a> procedures (civil status records, documents of origin).</p>", "<ul><li>проверка, какие документы в вашем деле действительно требуют перевода (вы не платите за лишние);</li><li>присяжный перевод (tłumaczenie przysięgłe) (наиболее частые языки наших клиентов — украинский, русский, английский и белорусский — обслуживаем также другие).</li></ul><p>Присяжные переводы требуются, в частности, в процедурах <a href=\"/uslugi/eu-blue-card\">Голубой карты ЕС (EU Blue Card)</a> (дипломы) и <a href=\"/uslugi/karta-stalego-pobytu\">постоянного проживания</a> (акты гражданского состояния, документы о происхождении).</p>", "<ul><li>перевірка, які документи у вашій справі дійсно потребують перекладу (ви не платите за зайві);</li><li>присяжний переклад (tłumaczenie przysięgłe) (найпоширеніші мови наших клієнтів — українська, російська, англійська та білоруська — обслуговуємо також інші).</li></ul><p>Присяжні переклади необхідні, зокрема, у процедурах <a href=\"/uslugi/eu-blue-card\">Блакитної карти ЄС (EU Blue Card)</a> (дипломи) та <a href=\"/uslugi/karta-stalego-pobytu\">постійного проживання</a> (акти цивільного стану, документи про походження).</p>"),
          },
          {
    ...
    services: [
      {
        ...
        sections: [
          ...
          {
            heading: loc("Na co uważać", "What to watch out for", "На что обратить внимание", "На що звернути увагу"),
            body: loc("<p>Obowiązki notyfikacyjne podmiotu powierzającego wykonywanie pracy oraz obowiązek zgłoszenia kopii umowy cudzoziemca przynajmniej dzień przed rozpoczęciem pracy. W określonych przypadkach szybszą alternatywą może być <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">oświadczenie o powierzeniu pracy</a> lub <a href=\"/uslugi/powiadomienia-o-powierzeniu-pracy\">powiadomienie</a> (dla obywateli Ukrainy).</p>", "<p>Notification obligations of the entity entrusting work and the obligation to submit a copy of the foreigner's contract at least one day before work begins. In certain cases, a faster alternative may be an <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">employer's declaration on entrusting work</a> or a <a href=\"/uslugi/powiadomienia-o-powierzeniu-pracy\">notification</a> (for Ukrainian citizens).</p>", "<p>Уведомительные обязанности субъекта, поручающего выполнение работы, а также обязанность подать копию договора иностранца как минимум за день до начала работы. В определённых случаях более быстрой альтернативой может быть <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">заявление о поручении работы (oświadczenie)</a> или <a href=\"/uslugi/powiadomienia-o-powierzeniu-pracy\">уведомление (powiadomienie)</a> (для граждан Украины).</p>", "<p>Повідомні обов'язки суб'єкта, що доручає виконання роботи, та обов'язок подати копію договору іноземця щонайменше за день до початку роботи. У визначених випадках швидшою альтернативою може бути <a href=\"/uslugi/oswiadczenie-o-powierzeniu-pracy\">заява про доручення роботи (oświadczenie)</a> або <a href=\"/uslugi/powiadomienia-o-powierzeniu-pracy\">повідомлення (powiadomienie)</a> (для громадян України).</p>"),
          },
        ],
        faq: [
          {
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            body: loc("<ul><li>zgłoszenie <strong>podjęcia</strong> pracy w ciągu 7 dni od rozpoczęcia pracy oraz <strong>niepodjęcia</strong> pracy w ciągu 14 dni od daty rozpoczęcia pracy wskazanej w oświadczeniu;</li><li>zgłoszenie zakończenia pracy cudzoziemca;</li><li>przesłanie kopii umowy zgodnej z oświadczeniem (co najmniej dzień przed rozpoczęciem pracy);</li><li>przekazanie dokumentów cudzoziemcowi.</li></ul><p>Wszystkie zgłoszenia przez praca.gov.pl, pod rygorem grzywny. Jeśli urząd przekracza terminy wpisania do ewidencji, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.</p>", "<ul><li>reporting the <strong>commencement</strong> of work within 7 days of the start of work and <strong>non-commencement</strong> of work within 14 days of the start date indicated in the declaration;</li><li>reporting the end of the foreigner's employment;</li><li>submitting a copy of the contract consistent with the declaration (at least one day before work begins);</li><li>providing documents to the foreigner.</li></ul><p>All reports are submitted via praca.gov.pl, under penalty of a fine. If the office exceeds registration deadlines, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.</p>", "<ul><li>сообщение о <strong>начале</strong> работы в течение 7 дней с момента начала работы и о <strong>неначале</strong> работы в течение 14 дней с даты начала работы, указанной в заявлении;</li><li>сообщение о завершении работы иностранца;</li><li>направление копии договора, соответствующего заявлению (как минимум за день до начала работы);</li><li>передача документов иностранцу.</li></ul><p>Все уведомления через praca.gov.pl, под угрозой штрафа. Если ведомство нарушает сроки внесения в реестр, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.</p>", "<ul><li>повідомлення про <strong>початок</strong> роботи протягом 7 днів від початку роботи та про <strong>непочаток</strong> роботи протягом 14 днів від дати початку роботи, зазначеної у заяві;</li><li>повідомлення про завершення роботи іноземця;</li><li>надсилання копії договору, що відповідає заяві (щонайменше за день до початку роботи);</li><li>передача документів іноземцю.</li></ul><p>Усі повідомлення через praca.gov.pl, під загрозою штрафу. Якщо відомство перевищує строки внесення до реєстру, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>.</p>"),
          },
          {
            heading: loc("Co obejmuje usługa GetPermit", "What the GetPermit service includes", "Что включает услуга GetPermit", "Що включає послуга GetPermit"),
        ...
        sections: [
          {
            ...
            body: loc("<p>Terminowe powiadomienie z prawidłowymi danymi. Każda zmiana pracodawcy rodzi obowiązek złożenia nowego powiadomienia. W powiadomieniach nie wskazuje się daty zakończenia pracy. Jeśli urząd przekracza terminy rozpatrywania sprawy pobytowej, można złożyć <a href=\"/uslugi/ponaglenia-i-odwolania\">ponaglenie</a>.</p>", "<p>Timely notification with correct data. Each change of employer creates an obligation to file a new notification. Notifications do not specify an end date for employment. If the office exceeds deadlines for processing the residence case, you can file a <a href=\"/uslugi/ponaglenia-i-odwolania\">reminder for failure to act</a>.</p>", "<p>Своевременное уведомление (powiadomienie) с правильными данными. Каждая смена работодателя порождает обязанность подачи нового уведомления. В уведомлениях не указывается дата окончания работы. Если ведомство нарушает сроки рассмотрения дела о проживании, можно подать <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглене (жалобу на бездействие)</a>.</p>", "<p>Вчасне повідомлення (powiadomienie) з правильними даними. Кожна зміна роботодавця породжує обов'язок подання нового повідомлення. У повідомленнях не зазначається дата закінчення роботи. Якщо відомство перевищує строки розгляду справи про проживання, можна подати <a href=\"/uslugi/ponaglenia-i-odwolania\">понаглення (скаргу на бездіяльність)</a>.</p>"),
          },
          {
